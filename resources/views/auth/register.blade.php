                            ...
                            <div class="block-content">
                                <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="py-3">
                                            <div class="mb-4">
                                                <input type="text" class="form-control form-control-lg form-control-alt"  name="name" placeholder="Username">
                                            </div>
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                <input type="password" class="form-control form-control-lg form-control-alt" name="password_confirmation" placeholder="Confirm Password">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
